...
public class UserCommentController {
	...
	public String detail(@PathVariable Long id, Model model) {
		UserComment comment = this.userCommentService.findById(id);
	...
	@GetMapping("/updatecorpus/{id}")
	@ResponseBody
	public String updatecorpus(@PathVariable Long id, Model model) {
		try {
			UserRemark userRemark = this.userRemarkService.findById(id);
			UserComment comment = userRemark.getUserComment();
	...
	public String myRemark(Integer pageIndex, Integer pageSize, Model model) {
		...
		PageData<UserRemark> pageData = this.userRemarkService.getPageData(pageIndex, pageSize,
